...
export default function LoginPage() {
    ...
    const validateForm = () => {
        ...
        if (!username) {
            ...
            newErrors.username = 'Username must be 3–16 characters and contain only letters, numbers, or underscores';
        }
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            try {
                ...
                setErrors({ form: "Invalid username or password" }); // Global form error
            } finally {
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 bg-background border ${errors.username ? 'border-destructive' : 'border-input'
