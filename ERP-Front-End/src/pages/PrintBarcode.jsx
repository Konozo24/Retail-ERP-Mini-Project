    ...
    <div className="min-h-screen bg-gray-50 p-6 font-sans text-gray-700">
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex space-x-2">
            <button className="p-2 bg-white border rounded shadow-sm hover:bg-gray-50 text-gray-500"><FaSync /></button>
            <button className="p-2 bg-white border rounded shadow-sm hover:bg-gray-50 text-gray-500"><FaChevronUp /></button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end border-b border-gray-100 pb-8 mb-6">
            ...
            <div className="flex space-x-8 justify-end">
                <div className="flex flex-col items-center cursor-pointer" onClick={() => toggleSetting('showProductName')}>
                    <span className="text-sm font-medium text-gray-600 mb-2">Show Product Name</span>
                    <div className={`relative h-6 w-11 rounded-full transition-colors ${settings.showProductName ? 'bg-green-500' : 'bg-gray-300'}`}>
                        <span className={`absolute top-1 left-1 bg-white h-4 w-4 rounded-full transition-transform ${settings.showProductName ? 'translate-x-5' : 'translate-x-0'}`} />
                    </div>
                </div>

                <div className="flex flex-col items-center cursor-pointer" onClick={() => toggleSetting('showPrice')}>
                    <span className="text-sm font-medium text-gray-600 mb-2">Show Price</span>
                    <div className={`relative h-6 w-11 rounded-full transition-colors ${settings.showPrice ? 'bg-green-500' : 'bg-gray-300'}`}>
                        <span className={`absolute top-1 left-1 bg-white h-4 w-4 rounded-full transition-transform ${settings.showPrice ? 'translate-x-5' : 'translate-x-0'}`} />
                    </div>
                </div>
            </div>
        </div>
