...
export function useCreateSalesOrder() {
	...
	return useMutation({
		...
		onSuccess: async () => {
			// Invalidate and eagerly refetch all sales statistics queries (any params)
			await qc.invalidateQueries({ queryKey: ['salesStatistic'] });
			await qc.refetchQueries({ queryKey: ['salesStatistic'] });
