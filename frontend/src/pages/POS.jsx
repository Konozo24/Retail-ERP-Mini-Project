...
import {
	...
	LayoutDashboard, Menu, CreditCard, Banknote, Loader2, LogOut
} from 'lucide-react';
		...
		<div className="flex items-center gap-3">
			...
			<div className="flex items-center gap-3 pl-2">
				<div className="text-right hidden sm:block">
					<p className="text-sm font-bold text-foreground">{user?.email || 'User'}</p>
					<p className="text-xs text-muted-foreground">{user?.role === 'ADMIN' ? 'Admin' : 'Cashier'} • Point of Sale</p>
				</div>
